...
public class BookRentalViewModel  extends AbstractViewModel<BookRentalVo, BookRentalRequest> {

    public BookRentalViewModel(@NonNull Application application) {
        super(BookRentalVo.class, URL_CONSTANTS.BOOK_RENTAL_URL, application);
    }

    @Override
    protected BookRentalRequest getEntityRequest(BookRentalVo bookRentalVo) {
